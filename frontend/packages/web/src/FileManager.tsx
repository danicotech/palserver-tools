...
export function FileBrowserDialog({
  ...
  return (
    ...
    >
      <div
        className={`${card} my-auto flex max-h-[90dvh] w-[860px] max-w-full flex-col gap-3 overflow-y-auto`}
...
export function FileEditor({
  ...
  return (
    ...
    >
      <div
        className={`${card} flex h-[80dvh] w-[900px] max-w-full flex-col gap-3`}
        onClick={(e) => e.stopPropagation()}
      >
