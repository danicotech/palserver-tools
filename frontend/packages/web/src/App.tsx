...
import { FiActivity, FiAlertTriangle, FiClock, FiCpu, FiDownload, FiFolder, FiHardDrive, FiPlus, FiServer, FiSettings, FiStar, FiUsers, FiZap } from "react-icons/fi";
...
function CreateDialog({
  ...
  return (
    <Overlay onClose={onClose}>
      <div
        className={`${card} flex max-h-[90dvh] w-[520px] max-w-full flex-col gap-3 overflow-y-auto`}
