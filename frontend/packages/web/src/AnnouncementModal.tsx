...
export function AnnouncementPopup() {
  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center overflow-y-auto bg-[rgb(35_32_48/0.55)] p-4 backdrop-blur-[3px] sm:p-6">
      <div className={`${card} max-h-[90dvh] w-[460px] max-w-full overflow-y-auto`}>
        ...
        <div className="mt-3 max-h-[60dvh] overflow-y-auto pr-1 text-[13px] leading-relaxed text-ink">
