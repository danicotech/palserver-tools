  ...
  return (
    <>
      <div
        ...
        // 矩形,永遠不知道何時該再現身。
        className={`pointer-events-none fixed bottom-2 left-3 z-10 max-w-[calc(100vw-1.5rem)] select-none text-[11px] leading-tight text-ink-muted/70 transition-opacity ${
