...
/**
 * 外觀主題選擇器(質感彈窗):多套主題各帶迷你即時預覽,頂部切深/淺,選中有勾勾。
 * 公開版:所有主題一律免費開放,無鎖定。
 */
export function ThemePicker({ onClose }: { entitled?: boolean; onClose: () => void }) {
  useI18n();
  ...
  return (
    <Overlay onClose={onClose}>
      <div
        className={`${card} flex max-h-[90dvh] w-140 max-w-full flex-col gap-4 overflow-y-auto`}
