...
import { FiCheck, FiCode, FiCopy, FiExternalLink, FiMessageCircle, FiStar, FiX } from "react-icons/fi";
    ...
    <div className="flex flex-col gap-4">
      ...
      <section className={card}>
        ...
        <div className="mt-3">
          ...
          {showLogs && (
            <div className="mt-2 max-h-72 overflow-y-auto overflow-x-auto rounded-lg border border-line bg-ink/95 p-3 font-mono text-[11px] leading-relaxed">
              {logs.length === 0 ? (
