...
export function DirectoryPicker({
  ...
  return (
    <div
      className="fixed inset-0 z-10 flex items-start justify-center overflow-y-auto bg-[rgb(35_32_48/0.55)] p-4 backdrop-blur-[3px] sm:p-6"
      onClick={onClose}
    >
      <div
        className={`${card} my-auto flex max-h-[90dvh] w-[600px] max-w-full flex-col gap-3 overflow-y-auto`}
      ...
      >
        ...
        <div className="flex gap-2">
          <input
            className={`${inputCls} min-w-0 flex-1 font-mono text-base sm:text-xs`}
            value={manualPath}
        ...
        {/* 目錄列表 */}
        <div className={`${card} max-h-[50dvh] overflow-y-auto p-0`}>
          {entries === null ? (
