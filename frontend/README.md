...
1. 到 [Releases](https://github.com/your-org/palserver-gui/releases) 下載你系統對應的壓縮檔
...
| `PALSERVER_GITHUB_REPO` | `your-org/palserver-gui` | 自我更新要看哪個 repo 的 Releases |
...
**v2 目前版本為 v2.1.0**,已可直接到 [Releases](https://github.com/your-org/palserver-gui/releases) 下載使用,
上面列的功能都已經上線。
