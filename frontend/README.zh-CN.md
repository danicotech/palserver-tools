...
1. 到 [Releases](https://github.com/your-org/palserver-gui/releases) 下载你系统对应的压缩包
...
| `PALSERVER_GITHUB_REPO` | `your-org/palserver-gui` | 自我更新要看哪个 repo 的 Releases |
...
**v2 目前版本为 v2.1.0**,已可直接到 [Releases](https://github.com/your-org/palserver-gui/releases) 下载使用,
上面列的功能都已经上线。
