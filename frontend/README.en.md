...
If you hit a problem, please open an issue on the project's GitHub Issues.
...
1. Download the archive for your OS from [Releases](https://github.com/your-org/palserver-gui/releases)
...
| `PALSERVER_GITHUB_REPO` | `your-org/palserver-gui` | Which repo's Releases self-update watches |
...
**v2 is currently at v2.1.0**, downloadable right now from [Releases](https://github.com/your-org/palserver-gui/releases) —
